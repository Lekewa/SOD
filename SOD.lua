...
jumpInput.FocusLost:Connect(function() if player.Character then player.Character.Humanoid.JumpPower = tonumber(jumpInput.Text) or 50 end end)
...
p.Size = Vector3.new(5, 1, 5); p.Position = player.Character.HumanoidRootPart.Position - Vector3.new(0, 3.5, 0); p.Anchored = true; p.Color = Color3.fromRGB(0, 255, 0); p.Material = Enum.Material.Neon; p.Parent = workspace
